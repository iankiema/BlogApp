...
#   end
first_user = User.create(name: 'Juwairiyya Sadiq', photo: 'https://e0.pxfuel.com/wallpapers/820/800/desktop-wallpaper-cute-black-girls-black-cartoon-characters-thumbnail.jpg',
...
Comment.create(user_id: first_user.id, post_id: first_post.id, text: 'Great post!')
Comment.create(user_id: second_user.id, post_id: second_post.id, text: 'Good post!')
Like.create(user_id: second_user.id, post_id: first_post.id)
